# This is the teleoperation script for XLerobot using the keyboard.
# To Run on the host
# python -m lerobot.robots.xlerobot.xlerobot_host --robot.id=my_xlerobot

# To Run the teleop:
# python -m examples.xlerobot.teleoperate
...
def main():
    ...
    FPS = 50
    # --- MODIFY THIS --- #
    # This IP is for local/wired connection, for remote connection, replace with the actual IP of the robot.
    ip = "localhost"
